...
<div class="app-wrapper">
    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?= base_url('pelatihan/kelas') ?>"><i class="bi bi-journals"></i> Kelas Saya</a>
            </li>
            <li>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm rounded-4 mb-4 px-4 py-3">
            <div class="container-fluid">
                <span class="navbar-brand mb-0 h5 fw-bold">Pengaturan Akun</span>
        ...
        <div class="container-fluid px-0">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start gap-4 mb-4">
                        ...
                        <div class="text-center">
                            <img src="<?= $fotoUrl ?>" class="rounded-circle shadow-sm border" width="130" height="130" style="object-fit: cover;">
                        </div>

                        <!-- NAMA DAN STATUS -->
                        <div class="text-center text-md-start flex-grow-1">
                            <h3 class="fw-bold mb-1"><?= esc($pendaftaran['nama'] ?? $user['nama'] ?? '-') ?></h3>
                            <p class="text-muted mb-2">Peserta CreativeMU Academy</p>

                            <?php if (!empty($pendaftaran['status'])): ?>
                                <span class="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill"><?= esc($pendaftaran['status']) ?></span>
                            <?php endif; ?>
                        </div>

                        <!-- TOMBOL EDIT -->
                        <div class="d-flex gap-2">
                            <a href="<?= base_url('pelatihan/edit-profil') ?>" class="btn btn-primary rounded-pill px-4">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                ...
                                <span class="fw-semibold"><?= esc($pendaftaran['nama'] ?? $user['nama'] ?? '-') ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                ...
                                <span class="fw-semibold"><?= esc($pendaftaran['email'] ?? $user['email'] ?? '-') ?></span>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                <small class="text-muted d-block mb-1">Nomor HP / WhatsApp</small>
                                <span class="fw-semibold"><?= esc($pendaftaran['no_hp'] ?? $user['no_hp'] ?? '-') ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                ...
                                <span class="fw-semibold"><?= esc($pendaftaran['jenis_kelamin'] ?? $user['jenis_kelamin'] ?? '-') ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                ...
                                <span class="fw-semibold"><?= esc($pendaftaran['ttl'] ?? '-') ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                ...
                                <span class="fw-semibold"><?= esc($pendaftaran['pendidikan_terakhir'] ?? '-') ?></span>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                <small class="text-muted d-block mb-1">Asal Sekolah / Kampus</small>
                                <span class="fw-semibold"><?= esc($user['asal_sekolah'] ?? '-') ?></span>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3">
                                <small class="text-muted d-block mb-1">Lokasi Pelatihan</small>
                                <span class="fw-semibold"><?= esc($pendaftaran['lokasi_pelatihan'] ?? '-') ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="p-3 bg-light rounded-3">
                                ...
                                <span class="fw-semibold"><?= esc($pendaftaran['alamat'] ?? '-') ?></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted mb-4">Kelola kata sandi untuk menjaga keamanan akun Anda.</p>

                    <a href="<?= base_url('pelatihan/ubah-password') ?>" class="btn btn-warning rounded-pill px-4 text-dark fw-semibold">
