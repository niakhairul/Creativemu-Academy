...
<div class="container py-5">
    ...
    <div class="alert alert-danger alert-dismissible fade show rounded-4 shadow-sm border-0 mb-4" role="alert">
        <i class="fas fa-exclamation-circle me-2"></i><strong>Gagal!</strong>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-10">
            ...
            <!-- FORM UTAMA -->
            <form action="<?= base_url('pelatihan/simpan-pendaftaran') ?>" method="post" enctype="multipart/form-data"[cite: 10]>
                <?= csrf_field() ?>
                    ...
                    <div class="col-lg-5">
                        <div class="main-card p-4 sticky-top" style="top: 20px;">
                            ...
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <span class="badge px-2 py-1 fw-bold rounded" style="color: #7c3aed; background-color: rgba(124, 58, 237, 0.1) !important; font-size: 0.7rem;">
                    ...
                    <div class="col-lg-7">
                        <div class="main-card p-4 p-md-5">
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">Silakan baca ketentuan sebelum melanjutkan pendaftaran.</p>
                                    </div>
                                </div>

                                <div class="ketentuan-card shadow-sm">
                                    <img src="<?= base_url('uploads/syarat_dan_persetujuan/syarat_dan_persetujuan.jpeg') ?>" alt="Syarat dan Ketentuan Pendaftaran" class="img-fluid"[cite: 10]>
                                </div>
                            </div>

                            <!-- Persetujuan Syarat & Ketentuan -->
                            <div class="form-check mb-4 bg-light p-3 rounded-3 border">
                                <input class="form-check-input mt-1" type="checkbox" value="1" id="persetujuan_syarat" name="persetujuan_syarat" checked required>
                                <label class="form-check-label small text-secondary ms-1" for="persetujuan_syarat">
                                    Saya menyetujui seluruh <a href="<?= base_url('uploads/syarat_dan_persetujuan/syarat_dan_persetujuan.jpeg') ?>" target="_blank" class="text-decoration-underline fw-semibold" style="color: #7c3aed;">syarat dan ketentuan</a> serta <a href="<?= base_url('kebijakan-privasi') ?>" target="_blank" class="text-decoration-underline fw-semibold" style="color: #7c3aed;">kebijakan privasi</a> yang berlaku di Creativemu Academy.
                                </label>
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="nama" name="nama" value="<?= esc($user['nama'] ?? '') ?>" required placeholder="Nama Lengkap">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" id="email" name="email" value="<?= esc($user['email'] ?? '') ?>" required placeholder="Email">
                                        <label for="email">Alamat Email</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?= esc($user['no_hp'] ?? '') ?>" required placeholder="Nomor HP">
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="alamat" name="alamat" style="height: 100px" required placeholder="Alamat Lengkap"><?= esc($user['alamat'] ?? '') ?></textarea>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="ttl" name="ttl" value="<?= esc($user['ttl'] ?? '') ?>" required placeholder="Tempat, Tanggal Lahir">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" id="pilihan_status" name="pilihan_status" required>
                                            ...
                                            <option value="Pelajar SMP" <?= (isset($user['pilihan_status']) && $user['pilihan_status'] == 'Pelajar SMP') ? 'selected' : '' ?>>Pelajar SMP</option>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" class="form-control py-2" id="pas_foto" name="pas_foto" accept="image/png, image/jpeg, image/jpg">
                                <div class="form-text text-muted" style="font-size: 0.75rem;">Maksimal 2 MB (JPG/PNG).</div>
                            </div>

                            <hr class="text-muted opacity-25 my-4">

                            <!-- Bagian 2: Pilih Kelas & Metode -->
                            <div class="d-flex align-items-center mb-4">
                                <div class="section-icon me-3">
                                    <i class="fas fa-layer-group fa-lg"></i>
                                </div>
                                <div>
                                    <h5 class="fw-bold text-dark mb-0">Pilih Kategori Kelas & Metode</h5>
                                    <p class="text-muted small mb-0">Tentukan preferensi belajar Anda.</p>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="metode_pembelajaran" name="metode_pembelajaran" required[cite: 10]>
                            ...
                            <!-- PILIHAN: Lokasi Pelatihan (Urut tepat di bawah metode pembelajaran jika offline dipilih) -->
                            <div class="mb-3" id="lokasiPelatihanContainer" style="display: none;">
                                <label for="pilihan_lokasi" class="form-label fw-semibold small text-secondary">Lokasi Pelatihan Offline <span class="text-danger">*</span></label>
                                <select class="form-select" id="pilihan_lokasi" name="pilihan_lokasi"[cite: 10]>
                                    <option value="" disabled selected>Pilih Lokasi Pelatihan</option>
                                    <option value="Kantor pusat - Jl. Gn. Bulu No 89, RT.34, Bandut Lor,Argorejo,Sedayu, Bantul, Yogyakarta">Kantor pusat - Jl. Gn. Bulu No 89, RT.34, Bandut Lor,Argorejo,Sedayu, Bantul, Yogyakarta</option>
                                    <option value="Kantor Cabang - Jl. Glagahsari No.46C, Warungboto, Kec.umbulharjo, Kota Yogyakarta, Daerah Istimewa Yogyakarta">Kantor Cabang - Jl. Glagahsari No.46C, Warungboto, Kec.umbulharjo, Kota Yogyakarta, Daerah Istimewa Yogyakarta</option>
                                    <option value="Kantor Perwakilan - Jl . Soekarno Hatta, Sawitan, Kabupaten Magelang, Jawa Tengah">Kantor Perwakilan - Jl . Soekarno Hatta, Sawitan, Kabupaten Magelang, Jawa Tengah</option>
                                </select>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-6">
                                    <input type="radio" class="btn-check" name="metode_pembayaran" id="bayar_cod" value="COD" onchange="togglePembayaran()" required[cite: 10]>
                                ...
                                <div class="col-6">
                                    <input type="radio" class="btn-check" name="metode_pembayaran" id="bayar_transfer" value="Transfer" onchange="togglePembayaran()"[cite: 10]>
                            ...
                            <!-- Informasi COD -->
                            <div id="infoCod" class="alert border-0 shadow-sm rounded-4 p-3 mb-3" style="display:none; background-color: #fef3c7;">
                            ...
                            <div id="uploadBukti" class="mb-4" style="display:none;">
                                ...
                                <input type="file" name="bukti_pembayaran" class="form-control py-2">
...
<!-- Script Toggle Pembayaran & Lokasi -->
<script>
function toggleLokasiPelatihan() {
    const metode = document.getElementById('metode_pembelajaran').value;
...
document.getElementById('metode_pembelajaran').addEventListener('change', toggleLokasiPelatihan);
